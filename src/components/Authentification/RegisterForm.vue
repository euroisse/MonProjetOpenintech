<template>
  <div class="pt-10 flex w-full max-w-full mx-auto items-center justify-center">
    <div
    ...
    >
      ...
      <div class="relative w-1/2 hidden md:block">
        ...
        <div
          ...
          "
        >
          <img src="../Images/logo.png" alt="logo-image" class="left-4 w-16" />
        </div>
      </div>
            ...
            <div class="flex flex-col gap-1">
              ...
              <div class="relative w-full">
                ...
                <input
                  ...
                  class="w-full pl-10 py-2 border text-left rounded-lg focus:outline-none focus:ring-2 focus:ring-yellow-500"
                  required
            ...
            <div class="flex flex-col gap-1">
              ...
              <div class="relative">
                ...
                <input
                  ...
                  class="w-full pl-10 py-2 text-left border rounded-lg focus:outline-none focus:ring-2 focus:ring-yellow-500"
            ...
            <div class="mt-5 flex flex-row gap-10">
              <div class="flex flex-col gap-1">
                <div class="relative">
                  <span class="icon-style"
                    ><i
                      class="ri-login-box-line text-black cursor-pointer hover:text-gray-700"
                    ></i
                  ></span>
                  <p
                    class="text-black pl-10 cursor-pointer hover:text-gray-700"
                  >
              ...
              <div>
                <div class="flex flex-col gap-1">
                  <div class="relative">
                    <span class="icon-style"
                      ><i
                        class="ri-question-fill text-black cursor-pointer hover:text-gray-700"
                      ></i
                    ></span>
                    <p
                      class="text-black pl-10 cursor-pointer hover:text-gray-700"
...
const soumettreFormulaire = async () => {
  erreurs.value.firstname = utilisateur.value.firstname
    ? ""
    : "Le nom est obligatoire.";
  erreurs.value.email = utilisateur.value.email
    ? ""
    : "L'email est obligatoire.";
  erreurs.value.password = utilisateur.value.password
    ? ""
