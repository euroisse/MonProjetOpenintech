<template>
  <div class="pt-10 flex mx-auto items-center justify-center">
    <form
      ...
      class="mt-6 bg-white w-[60%] p-10 rounded-lg shadow-md"
    >
      ...
      <div class="mb-4 relative">
        ...
        <div class="relative flex items-center">
          ...
          <div
            v-if="showError.email && erreurs.email"
            class="absolute top-[-30px] left-0 bg-red-500 text-white text-sm px-2 py-1 rounded shadow-md"
          >
            {{ erreurs.email }}
          </div>
        </div>
      ...
      <div class="mb-4 relative">
        ...
        <div class="relative flex items-center">
          ...
          <!-- Message d'erreur qui apparaît en survol -->
          <div
            v-if="showError.password && erreurs.password"
            class="absolute top-[-30px] left-0 bg-red-500 text-white text-sm px-2 py-1 rounded shadow-md"
          >
            {{ erreurs.password }}
          </div>
      ...
      <div class="mt-5">
        <p class="text-black cursor-pointer text-center">
          ...
          <router-link to="/registerForm">
            <span class="text-blue-400 hover:text-blue-700">
...
const seConnecter = async () => {
  ...
  try {
    const response = await axios.post(
      "https://booking.openintech.app/api/login",
      utilisateur.value,
      {
        headers: {
